function actionSegment(name_form){
    $(name_form).validate({
                rules: {
...
function mySegment(){
	$('#dataDisplays').flexigrid({
    		url: base_url+"/setting_up/segment/getdata",
    		dataType: 'json',
    		...
    		colModel : [
                {display: 'Kode', name : 'segment_code',width:100, sortable : true, align: 'left'},
                {display: 'Keterangan', name : 'segment_label',width:300, sortable : true, align: 'left'},
                {display: 'Status', name : 'segment_status',width:150, sortable : true, align: 'left'},
                {display: 'Perusahaan', name : 'com_code',width:100, sortable : true, align: 'left'}
            ],
    		searchitems : false,
    		sortname: 'segment_code',
    		sortorder: 'asc',
    		usepager: true,
    		title: false,
    		useRp: false,
	...
	$('#btnSearch').click(function(){
		$('#dataDisplays').flexOptions({ query: $(".dataSearch").val(),qtype: $("#cmbKey").val(), rp: 10,sortname: 'segment_code', sortorder: 'asc' }).flexReload();
        return false;
	});
}
